              ...
              <div className="w-full md:w-3/4 flex flex-col bg-card rounded-lg shadow-sm overflow-hidden">
                ...
                maxHeight: "500px"
                  ...
                  {messages.map(message => <div key={message.id} className={`flex ${message.sender === "user" ? "justify-end" : "justify-start"}`}>
                      <div className={`max-w-[80%] rounded-lg p-4 ${message.sender === "user" ? "bg-primary text-primary-foreground" : "bg-muted"}`}>
                        ...
                        {message.suggestedCommand && <div className="mt-3 p-3 border bg-card rounded-md">
                            ...
                            {message.suggestedCommand.examples && <div className="mt-2">
                ...
                <div className="border-t p-4">
                  <div className="flex gap-2">
                    <Textarea value={input} onChange={e => setInput(e.target.value)} onKeyDown={handleKeyPress} placeholder="Ask about a command or task..." className="min-h-[60px] rounded-full " />
              ...
              <div className="w-full md:w-1/4">
                <div className="bg-card rounded-lg shadow-sm p-4">
                  ...
                  <div className="space-y-2">
                    {["How to find files in Linux?", "Command to list network connections", "How to check disk space?", "Process management commands", "How to create a new directory?"].map((query, i) => <Button key={i} variant="ghost" className="w-full justify-start text-sm h-auto py-2 px-3" onClick={() => setInput(query)}>
